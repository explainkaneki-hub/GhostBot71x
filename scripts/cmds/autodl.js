...
module.exports = {
  ...
  onChat: async function({ api, event, message }) {
    ...
    // Use the maintained alldl pipeline first. The old inline endpoint
    // remains below as a compatibility fallback for unusual responses.
    if (message) {
      return require("./alldl").onStart({
        api,
        event,
        message,
        args: [content]
