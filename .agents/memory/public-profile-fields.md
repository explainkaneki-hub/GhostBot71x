...
Social-profile APIs expose an inconsistent subset of public fields. Treat username, birthday, location, hobbies, favourite song, relationship, bio, and website as optional and display an explicit unavailable value when absent; never invent profile facts.
